...
<body>
	<nav class="container-fluid box box--secondary nav">
		<div class="row ">
			...
			<div class="col-xs-2 visible-xs visible-sm btn btn__menu_expand">
				<img src="/img/global/icon_expand_menu.png" class="img-responsive pull-right" alt="Menu Button">
			</div>


			<ul class="col-md-7 hidden-xs hidden-sm">
				<li class="pull-right">		
					<a class="nav__txt" href="googlemap.php" target="_top">Google Map Customizer</a>
				</li>

				<li class="pull-right">		
					<a class="nav__txt" href="about.php" target="_top">About</a>
				</li>

				<li class="pull-right">
					<a class="nav__txt " href="services.php">Works</a>
				</li>

				<li class="pull-right">		
					<a class="nav__txt" href="technology.php" target="_top">Blog</a>
				</li>
			</ul>
		</div>
			<!-- Mobile Menu -->
...
<!-- 	<div class="row">
			<div class="col-md-10 col-md-offset-1"> -->
				<div class="row">
					<div class="col-md-12">
						<h1 class="txt--title margin--element_top_lg">Mobile Application Design</h1>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-sm-6 col-md-4 margin--element_top_xl">
						<a href="/view/work/reclink.php" target="_top">
				...
				<div class="row">
					<div class="col-sm-6 col-md-4 margin--element_top_xl" >
						<a href="ivylla.php" target="_top">
							<img src="../img/work/work_img_urban-weaving.png" class="img-responsive center-block" alt="Urban Weaving Rendering">
							<h2 class="text-center margin--element_top_xs">Urban Weaving</h2>
						</a>
					</div>

					<div class="col-sm-6 col-md-4 margin--element_top_xl" >
						<a href="ivylla.php" target="_top">
							<img src="../img/work/work_img_floating-pavilion.png" class="img-responsive center-block" alt="Floating Pavilion Rendering">
							<h2 class="text-center margin--element_top_xs">Floating Pavilion</h2>
						</a>
					</div>

					<div class="col-sm-6 col-md-4 margin--element_top_xl">
						<a href="ambassador.php" target="_top">
							<img src="../img/work/work_img_energy-efficiency-vs-architectural-design.png" class="img-responsive center-block" alt="Energy Efficiency vs Architectural Design Rendering">
							<h2 class="text-center margin--element_top_xs">Energy Efficiency vs Architectural Design</h2>
						</a>
					</div>
					
					<div class="col-sm-6 col-md-4 margin--element_top_xl">
						<a href="ambassador.php" target="_top">
							<img src="../img/work/work_img_high-density-residential-district.png" class="img-responsive center-block" alt="High-density Residential District Design Diagram">
							<h2 class="text-center margin--element_top_xs">High-density Residential District</h2>
						</a>
					</div>
					
					<div class="col-sm-6 col-md-4 margin--element_top_xl">
						<a href="ambassador.php" target="_top">
							<img src="../img/work/work_img_high-density-vs-low-density.png" class="img-responsive center-block" alt="Apartment Section Drawing">
							<h2 class="text-center margin--element_top_xs">High-density/Low-density Apartment</h2>
						</a>
					</div>
					
					<div class="col-sm-6 col-md-4 margin--element_top_xl">
						<a href="ambassador.php" target="_top">
							<img src="../img/work/work_img_water-town-revitalization.png" class="img-responsive center-block" alt="Water Town Revitalization Diagram">
...
<!-- 		</div>
	...
	<footer class="margin--section_top">
		<div class="container-fluid">
			<div class="row margin--section_top">
				<div class="col-sm-7 col-sm-offset-1 col-md-6 col-md-offset-1 col-lg-5 col-lg-offset-2 margin--element_bottom_xs">
				...
				<div class="col-xs-4 col-sm-1 margin--element_bottom_xs">
					<a href="https://www.facebook.com/zhibin.cheng" target="_top">
						<img src="../img/global/icon_facebook.png" class="img-responsive center-block" alt="Facebook Icon">
					</a>
				</div>
				...
				<div class="col-xs-4 col-sm-1 margin--element_bottom_xs">
					<a href="https://twitter.com/ChengFolio" target="_top">
						<img src="../img/global/icon_twitter.png" class="img-responsive center-block" alt="Twitter Icon">
					</a>
				</div>
			</div>
		</div>
