...
2. Add informative content to the top. In the new shopping cart design, I moved shipping and tax fees on the top of the page to push the first item to the safe zone. However, you can notice that only the bottom part of the item is in the safe zone, to make it easy for users to click the ‘X‘ icon, I move it to the bottom and change it to ‘REMOVE‘.</p>
			...
			<div class="row margin--element_top">
				<div class="col-md-4 col-md-offset-2">
					<img src="/img/blog/one_handed_use/old_me_overlay.jpg" class="img-responsive center-block zone_overlay" alt="Selected work samples">
				...
				<div class="col-md-4">
					<img src="/img/blog/one_handed_use/new_me_overlay.jpg" class="img-responsive center-block zone_overlay" alt="Selected work samples">
					<img src="/img/blog/one_handed_use/new_me.jpg" class="img-responsive center-block zone_base" alt="Selected work samples">			
					<p class="text-center">Me (New)</p>
				</div>			
			</div>
			<div class="row margin--element_top">
				<div class="col-md-4 col-md-offset-2">
					<img src="/img/blog/one_handed_use/old_shopping_bag_overlay.jpg" class="img-responsive center-block zone_overlay" alt="Selected work samples">
					<img src="/img/blog/one_handed_use/old_shopping_bag.jpg" class="img-responsive center-block zone_base" alt="Selected work samples">
					<p class="text-center">Shopping Bag (Previous)</p>
				</div>
				<div class="col-md-4">
					<img src="/img/blog/one_handed_use/new_shopping_bag_overlay.jpg" class="img-responsive center-block zone_overlay" alt="Selected work samples">
					<img src="/img/blog/one_handed_use/new_shopping_bag.jpg" class="img-responsive center-block zone_base" alt="Selected work samples">			
			...
			<div class="row margin--element_top">
				<div class="col-md-4 col-md-offset-2">
					<img src="/img/blog/one_handed_use/old_detail_overlay.jpg" class="img-responsive center-block zone_overlay" alt="Selected work samples">
					<img src="/img/blog/one_handed_use/old_detail.jpg" class="img-responsive center-block zone_base" alt="Selected work samples">
					<p class="text-center">Detail (Previous)</p>
				</div>
				<div class="col-md-4">
					<img src="/img/blog/one_handed_use/new_detail_overlay.jpg" class="img-responsive center-block zone_overlay" alt="Selected work samples">
					<img src="/img/blog/one_handed_use/new_detail.jpg" class="img-responsive center-block zone_base" alt="Selected work samples">			
