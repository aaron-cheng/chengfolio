...
function googlemapcolorizer()
{
	...
	this.getItemDiv = function()
	{
		...
		value += '</div>';
		value += '<div class="wrap">';
		value += '	<div class="left hexcode" title="Hex codes are the 3 or 6-character codes that are often used in HTML and CSS to tell the browser what colors to display. So for example, #FFFFFF is the color white and #000000 is the color black.">HEX Color:</div>';
