...
<html>
<head>
	<title>Parking + Housing - A Space Efficiency Solution for Metropolises</title>
...
<?php include '../component/nav.php';?>
	...
	<div class="container work__header__wrapper padding--element_bottom_lg">
		<div class="row">
			<div class="col-md-3 col-md-offset-1 margin--element_top">
				<img src="/img/work/parking_housing/parking_housing_codesign_logo.png" class="img-responsive center-block margin--element_top" alt="A Space Efficiency Solution for Metropolises">
			</div>			
			...
			<div class="col-md-10 col-md-offset-1 margin--element_top_xs">
				<div class="row">
					<div class="col-md-8">
						...
						<p>Parking + Housing is published on <a href="http://www.travelchannel.com/shows/extreme-parking/video" class="txt--primary_on_light txt--regular">Travel Channel</a>, 
						<a href="http://www.fastcodesign.com/1670316/parking-spaces-that-convert-to-housing-crazy-or-crazy-smart" class="txt--primary_on_light txt--regular">Co Design</a>,
						<a href="http://www.treehugger.com/green-architecture/transformer-apartment-night-turns-parking-space-day.html" class="txt--primary_on_light txt--regular">Treehugger</a>,
						<a href="http://inhabitat.com/aaron-cheng-parking-housing-is-a-parking-garage-that-converts-to-housing-at-night" class="txt--primary_on_light txt--regular">Inhabitat</a>,
						<a href="http://www.craveonline.com/lifestyle/articles/192177-invention-lets-you-park-in-your-living-room" class="txt--primary_on_light txt--regular">Crave Online</a>,
						<a href="http://www.builderonline.com/building/will-micro-apartments-go-macro_o" class="txt--primary_on_light txt--regular">Builder</a>,
						<a href="http://www.multifamilyexecutive.com/property-management/apartment-trends/are-micro-units-here-to-stay_o" class="txt--primary_on_light txt--regular">Multifamily Executive</a>,
						<a href="http://www.detail-online.com/daily/multi-storey-multiplex-parking-housing-by-aaron-cheng-5597" class="txt--primary_on_light txt--regular">Detail Daily</a>,
						<a href="http://fullinsight.com/2012/07/parking-plus-housing-by-aaron-cheng" class="txt--primary_on_light txt--regular">Full Insight</a></p>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="container padding--element_lg">
		<div class="row">
			<div class="col-md-10 col-md-offset-1">
				<div class="row">
					<div class="col-md-8">
						<h2 class="txt--subtitle">Background</h2>
						<p class="margin--element_top_xs">The density in major metropolises is extremely high, and so is the land value. However, some space is not fully utilized. e.g. Parking Lots</p>	
					</div>
				</div>
		...
		<div class="container padding--element_lg">
			<div class="row">
				<div class="col-md-10 col-md-offset-1">
					<div class="row">
						<div class="col-md-8">
							<h2 class="txt--subtitle">Problem</h2>							
						</div>
					</div>
					<div class="row">
						<div class="col-sm-6">
					...
					<div class="row">
						<div class="col-md-8 margin--element_top_lg">
	...
	<div class="work__background--black">
		<div class="container padding--element_lg">
			<div class="row">
				<div class="col-md-10 col-md-offset-1">
					<div class="row">
		...
		<div class="container padding--element_bottom_lg">
			<div class="row">
				<div class="col-md-10 col-md-offset-1">
					<div class="row">
						<div class="col-md-8">
							<p class="txt--primary_on_light margin--element_top_xs">1. Living unit  &#160 &#160  2. Parking pallet  &#160 &#160  3. Retractable stair case  &#160 &#160  4. Corridor  &#160 &#160  5. Entry  &#160 &#160  6. Kitchen  &#160 &#160  7. Bathroom  &#160 &#160  8. Storage  &#160 &#160  9. TV  &#160 &#160  10. Tray Table</p>							
						</div>
					</div>
				</div>
			</div>
