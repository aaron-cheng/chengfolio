...
<?php include '../component/nav.php';?>
 ...
 I joined as the lead designer when the company was rebranding its entire product. The goal of this project is to improve the overall user experience of the flow designer and define the new UI infrastructure to accommodate all the current and future products as well as deliver simple and consistent user experience across the entire platform.</p>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="container padding--element_lg margin--section_top">
			<div class="row">
				<div class="col-md-10 col-md-offset-1">
					<div class="row">
						<div class="col-md-8">
							<h2 class="txt--subtitle">Object-Oriented UX</h2>
						</div>
					</div>

					<div class="row">
						<div class="col-md-12 margin--element_top" >
							<img src="/img/work/striim_flow_designer/extract_objects.png" class="img-responsive center-block" alt="Previous flow designer's screenshot">
							<p class="txt--primary_on_light margin--element_top_xs txt--img_caption">Extract basic objects and their operations</p>	
						</div>
					</div>

					<div class="row">
						<div class="col-md-12">
							<p class="txt--primary_on_light margin--element_top">Flow designer is a complicated project and contains many unfamiliar terms and concepts. In order for me to improve the design, I need to understand the product first. Object-oriented design becomes extremely helpful in this process. Stripping away interaction, color, and layout of previous design, I work with the PMs and engineers to come up with the diagrams showing a system of three objects: App, Flow, and Component. From the operation diagram, I noticed that there are 2 types of operation: the global operation can be used on multiple objects and the individual operation that can only be used on a single object. The regrouped diagram is helpful for me to prioritize content and design.  </p>
						</div>
					</div>					

					<div class="row">
						<div class="col-md-4 margin--element_top" >
							<img src="/img/work/striim_flow_designer/objects_relationship.png" class="img-responsive center-block" alt="Objects’ relationship diagram">
							<p class="txt--primary_on_light margin--element_top_xs txt--img_caption">Objects’ relationship</p>	
						</div>

						<div class="col-md-4 margin--element_top" >
							<img src="/img/work/striim_flow_designer/objects_operations.png" class="img-responsive center-block" alt="List of each object's operations">
							<p class="txt--primary_on_light margin--element_top_xs txt--img_caption">Operations of each object</p>	
						</div>

						<div class="col-md-4 margin--element_top" >
							<img src="/img/work/striim_flow_designer/reorganize_objects.png" class="img-responsive center-block" alt="Regroup objects' operations">
							<p class="txt--primary_on_light margin--element_top_xs txt--img_caption">Regroup operations by ‘global’ and ‘individual’</p>	
						</div>
					</div>	
	...
	<div class="container padding--element_top_lg">
		<div class="row">
			<div class="col-md-offset-1 col-md-10">
				<div class="row">
					<div class="col-md-8">
						<h2 class="txt--subtitle">UI Architecture for the Entire Platform</h2>
					</div>
				</div>
